...
- state_delta 允许的 target 前缀只有：vitals. / companions.<id>.vitals. / companions.<id>.alive / companions.<id>.present / inventory / flags. / clues / location / npcsAlive / threads / combat.active / combat.round / combat.foes。
